<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeFile="Account.aspx.cs" Inherits="digitTech.Account" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="800px" cellpadding="3" ForeColor="#7d1b0a" >
    <tr>
        <td>
            First Name
        </td>
        <td>
            <asp:TextBox ID="TextBox1" runat="server" Height="22px" Width="189px" BorderColor="#CC3300" 
    ...
    <tr align="left">
        ...
        <td>
            <asp:TextBox ID="TextBox2" BorderColor="#CC3300" 
    ...
    <tr>
        <td>
            ...
            <td><asp:TextBox ID="TextBox3" BorderColor="#CC3300" 
    ...
    <tr>
        ...
        <td>
            ...
            <asp:TextBox ID="TextBox7" BorderColor="#CC3300" 
        ...
        Font-Bold="True" ForeColor="Red" Width="189px"></asp:TextBox>
            ...
            <asp:RangeValidator ID="RangeValidator1" runat="server" 
               ForeColor="#FF3300" ControlToValidate="TextBox6" Display="Dynamic" ErrorMessage="Not in the correct format" 
                MaximumValue="9999999999" MinimumValue="10000"></asp:RangeValidator>
        </td>

    </tr><td></td>
        
        <td> <asp:Button ID="Button1" runat="server" CssClass="btn-warning" Text="Save" OnClick="Button1_Click" />
    <asp:Label ID="msg" runat="server" Text=""></asp:Label></td>
</tr>
</table><!--btn not woring-->
